...
import { filter, map } from "rxjs/rxjs/operators";
...
const consoleEpic = () => (action$: any) => {
  ...
  return merge(
    ...
    action$.ofType("ADD_PLAN_CONFIGURATION").pipe(
      map(action =>
    ...
    action$.ofType("FEATURE_LOAD").pipe(
      map(action =>
        addConsoleLogsForTask({
          ...molecule,
          severity: ConsoleLogInformation,
    ...
    action$.ofType("REMOVE_PLAN_CONFIGURATION").pipe(
      map(action =>
        addConsoleLogsForTask({
          ...molecule,
          severity: ConsoleLogInformation,
    ...
    action$.ofType("PIN_PLAN_CONFIGURATION").pipe(
      map(action =>
        addConsoleLogsForTask({
          ...molecule,
          severity: ConsoleLogInformation,
    ...
    action$.ofType("UNPIN_PLAN_CONFIGURATION").pipe(
      map(action =>
        addConsoleLogsForTask({
          ...molecule,
          severity: ConsoleLogInformation,
