...
const consoleEpic = () => (action$: any) => {
  ...
  return merge(
    ...
    action$.ofType("ADD_PLAN_CONFIGURATION")
      .pipe(map(action =>
    ...
    action$
      ...
      .pipe(filter(action => action.payload.ownSource),
        map(action => addConsoleSource(action.payload.name, true))),

    action$.ofType("FEATURE_LOAD").pipe(map(action =>
      addConsoleLogsForTask({
        ...molecule,
        severity: ConsoleLogInformation,
    ...
    action$.ofType("REMOVE_PLAN_CONFIGURATION").pipe(map(action =>
      addConsoleLogsForTask({
        ...molecule,
        severity: ConsoleLogInformation,
        message:
    ...
    action$.ofType("PIN_PLAN_CONFIGURATION").pipe(map(action =>
      addConsoleLogsForTask({
        ...molecule,
        severity: ConsoleLogInformation,
        message:
    ...
    action$.ofType("UNPIN_PLAN_CONFIGURATION").pipe(map(action =>
      addConsoleLogsForTask({
        ...molecule,
        severity: ConsoleLogInformation,
        message:
    ...
    action$.ofType("RUN_TASK").pipe(map(action =>
      addConsoleLogsForTask({
        ...molecule,
        severity: ConsoleLogInformation,
        message:
    ...
    action$.ofType("STOP_TASK").pipe(map(action =>
      addConsoleLogsForTask({
        ...molecule,
        severity: ConsoleLogInformation,
    ...
    action$.ofType("CRASH_TASK").pipe(map(action =>
      addConsoleLogsForTask({
        ...molecule,
    ...
    action$.ofType("FAIL_TASK").pipe(map(action =>
      addConsoleLogsForTask({
        ...molecule,
        severity: ConsoleLogError,
    ...
    action$.ofType("KILL_TASK").pipe(map(action =>
      addConsoleLogsForTask({
        ...molecule,
