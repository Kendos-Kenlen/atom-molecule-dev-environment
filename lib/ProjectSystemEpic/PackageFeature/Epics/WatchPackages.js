...
import type { WatchMan } from "../../../EventSystemEpic/FileFeature/Types/types";
import { filter, map, mergeAll, takeWhile } from "rxjs/operators";

const watchPackagesEpic = (watchman: WatchMan) => (action$: any, store: any) =>
  action$.ofType("PACKAGES_REFRESHED").pipe(
